...
const deleete_message_dto_1 = require("./dtos/deleete-message.dto");
let MessagesController = class MessagesController {
    ...
    createMessage(createMessageBodyDto) {
        return this.messageService.createMessage(createMessageBodyDto);
    }
    deleteMessage(deleteMessageBodyDto) {
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [deleete_message_dto_1.DeleteMessageDto]),
    __metadata("design:returntype", void 0)
