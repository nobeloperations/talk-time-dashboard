...
let RecordingService = class RecordingService {
    async getRecording(params, res) {
        ...
        try {
            ...
            if (access_token) {
                ...
                const matchingMessage = await this.findMatchingMessage(messages, access_token, generalName, date);
                if (matchingMessage) {
    ...
    async findMatchingMessage(messages, access_token, generalName, date) {
        ...
        return await this.findMatchingMessage(messages, access_token, generalName, date);
    }
};
