...
let RecordingService = class RecordingService {
    async getRecording(params, res) {
        ...
        try {
            ...
            if (access_token) {
                axios_1.default.get(`https://www.googleapis.com/gmail/v1/users/me/messages?q=from:${authorEmail}`, {
                    headers: {
                    ...
                    for (const message of messages) {
                        ...
                        axios_1.default.get(`https://www.googleapis.com/gmail/v1/users/me/messages/${messageId}`, {
                            headers: {
                                Authorization: `Bearer ${access_token}`
                            }
                        })
