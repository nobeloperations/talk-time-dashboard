...
export class RecordingService {
    async getRecording(params, res) {
        ...
        try {
            ...
            if (access_token) {
                axios.get(`https://www.googleapis.com/gmail/v1/users/me/messages?q=from:${authorEmail}`, {
                    headers: {
                    ...
                    .then(response => {
                        ...
                        for (const message of messages) {
                            ...
                            axios.get(`https://www.googleapis.com/gmail/v1/users/me/messages/${messageId}`, {
                                headers: {
                                    Authorization: `Bearer ${access_token}`
                                }
                            })
